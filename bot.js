...
if(!args[0]) {
  ...
  .setColor(0xFF0000)
  .setTitle(`:candy: ${message.author.username} s\'est donné(e) un bonbon! :candy:`)
  .setImage('https://data.whicdn.com/images/29808733/original.gif')
  message.channel.send({buyEmb})
  return;
  }
  ...
  .setColor(0xFF0000)
  .setTitle(`:candy: ${message.author.username} a donné(e) un bonbon à ${message.mentions.members.first().user.username} ! :candy:`)
  ...
  const buyEmb = new Discord.RichEmbed()
  .setColor(0xFF0000)
  .setTitle(`:candy: ${message.author.usernam} s\'est donné(e) un bonbon! :candy:`)
  .setImage('https://data.whicdn.com/images/29808733/original.gif')
  message.channel.send({buyEmb})
